...
{
    public class OrganizationalUnits : IDisposable
    {
        private readonly ILog log = LogManager.GetLogger(typeof(OrganizationalUnits));
        ...
        public OrganizationalUnits(string username, string decryptedPassword, string domainController)
        {
        ...
        public List<User> GetUsers(string distinguishedName)
        {
            DirectorySearcher dr = null;
